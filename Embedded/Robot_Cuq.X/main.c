...
void SetNextRobotStateInAutomaticMode() {
    ...
    if (robotState.distanceTelemetreXtrmGauche < 22) mask |= 0b10000;
    if (robotState.distanceTelemetreGauche < 30) mask |= 0b01000;
    if (robotState.distanceTelemetreCentre < 35) mask |= 0b00100;
    if (robotState.distanceTelemetreDroit < 30) mask |= 0b00010;
    if (robotState.distanceTelemetreXtrmDroit < 22) mask |= 0b00001;
